...
public class AES256Util {
     ...
     * 密钥, 256位32个字节
     */
    public static final String DEFAULT_SECRET_KEY = "C7Wz0tkKkfpO8JBn2MR4d5cBSatO11o9";
     ...
     */
    private static final byte[] KEY_VI = "yPbLi4FicYOJXgXn".getBytes();
    ...
    public static void main(String[] args) {
        ...
        System.out.println(RandomUIDUtils.getStrUID(32));
        System.out.println(RandomUIDUtils.getStrUID(16));

        for (String dbPassword : Lists.newArrayList("", "")) {

            String encryptDbPwd = AES256Util.encode(DEFAULT_SECRET_KEY, dbPassword);
            System.out.println("encrypt: " + encryptDbPwd);

            String decrypt = AES256Util.decode(DEFAULT_SECRET_KEY, dbPassword);
